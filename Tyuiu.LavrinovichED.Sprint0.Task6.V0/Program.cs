using Tyuiu.LavrinovichED.Sprint0.Task6.V0.Lib; 

namespace Tyuiu.LavrinovichED.Sprint0.Task6.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Пример циклической структуры находится в библиотеке классов методе SubtractionArray
